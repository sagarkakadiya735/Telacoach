          ...
          <div class="" >
            <div class=" border-bottom">
              <div class="px-4 font-weight-bold">
               <router-link class="text-dark" to="/Community">
            ...
            <div class="text-center h4 py-2 text-center font-weight-bold pb-2 pr-5">Comment</div>
            </div>
           ...
           <div class="row bg-blue-light border-radius my-4" v-for="(item, index) in community_respo" :key="index">
             <div class="col-2 py-2">
               ...
               <div class="text-green pl-3 text-title pt-2 font"> {{item.username}} </div>
             </div>
  ...
  components: {
   ...
   methods: {
      ...
      async community() {
        ...
        formData.append("community_id",this.$route.params.id)
      ...
      let res = await apiServices.makeAPICall(
        ...
        apiServices.URL + apiServices.save_commentAPI,
        formData,
        () => {}
      );
      if (res.data.flag == 1) {
      ...
      async Send() {
        ...
        formData.append("access_token",this.user.access_token)
         ...
         if(this.users.message){
           formData.append("comment",this.users.message)
         }
        formData.append("timezone",constants.timezone)
