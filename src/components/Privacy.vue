...
<template>
  <div>
    <Header />
      ...
      <h2 class="font-weight-bold pt-4">My Plan</h2>
        ...
        <div class="container pb-5">
            <div class="container box-shadow border-rounde mt-5 p-0 bg-white" style="width: 750px">
                <div class="">
                    ...
                    <div class="text-center h5 text-center font-weight-bold border-bottom pr-100 mb-0 pb-4">Privacy</div>
                   
                   <div class="px-5 pb-5 about-text" v-html="privacy_data">
                      <p>{{privacy_data}}</p>
                   </div>
                   </div>
...
export default {
  ...
  methods: {
    async getPrivacyData() {
      ...
      if(res.data.flag == 1) {
        this.privacy_data = res.data.data.privacy_policy_content
      }
      else {
